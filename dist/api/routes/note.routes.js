...
router.post('/note', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newNoteReq, noteRepo, newNote, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                noteRepo = (0, typeorm_1.getRepository)(Note_1.Note);
                newNote = noteRepo.create(newNoteReq);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, noteRepo.save(newNote)];
            case 2:
                result = _a.sent();
